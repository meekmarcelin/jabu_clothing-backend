...
`;var Ct=require("formik"),$n=e=>{const n=(0,d.useRef)(null),{isSubmitting:r,isValidating:o,errors:a,touched:l}=(0,Ct.useFormikContext)();return(0,d.useEffect)(()=>{if(r&&!o){const c=n.current.querySelectorAll("[data-strapi-field-error]");if(c.length>0){const u=c[0].getAttribute("id"),m=n.current.querySelector(`[aria-describedby="${u}"]`);m&&m.focus()}}if(!r&&!o&&Object.keys(a).length){const c=document.getElementById("global-form-error");c&&c.focus()}},[a,r,o,l]),i().createElement(Ct.Form,{ref:n,...e,noValidate:!0})},An=e=>{if(!e)return{maximum:void 0,minimum:void 0};const{minLength:n,maxLength:r,max:o,min:a}=e;let l,c;const s=parseInt(a,10),u=parseInt(n,10);Number.isNaN(s)?Number.isNaN(u)||(l=u):l=s;const m=parseInt(o,10),f=parseInt(r,10);return Number.isNaN(m)?Number.isNaN(f)||(c=f):c=m,{maximum:c,minimum:l}},Dn=({type:e,minimum:n,maximum:r})=>{if(["biginteger","integer","number"].includes(e))return{};const o=Math.max(n||0,r||0);return{message:{id:"content-manager.form.Input.hint.character.unit",defaultMessage:"{maxValue, plural, one { character} other { characters}}"},values:{maxValue:o}}},jn=({description:e,fieldSchema:n,type:r})=>{const{formatMessage:o}=(0,x.useIntl)(),a=()=>e?.id?o({id:e.id,defaultMessage:e.defaultMessage},{...e.values}):"";return{hint:(()=>{const{maximum:c,minimum:s}=An(n),u=Dn({type:r,minimum:s,maximum:c}),m=typeof s=="number",f=typeof c=="number",g=f&&m,h=f||m;return!e?.id&&!h?"":o({id:"content-manager.form.Input.hint.text",defaultMessage:"{min, select, undefined {} other {min. {min}}}{divider}{max, select, undefined {} other {max. {max}}}{unit}{br}{description}"},{min:s,max:c,description:a(),unit:u?.message&&h?o(u.message,u.values):null,divider:g?o({id:"content-manager.form.Input.hint.minMaxDivider",defaultMessage:" / "}):null,br:h?i().createElement("br",null):null})})()}},D=e=>`${e/16}rem`;const Ae=({hint:e,label:n,labelAction:r,error:o,name:a,required:l})=>i().createElement(p.TextInput,{disabled:!0,error:o,label:n,labelAction:r,id:a,hint:e,name:a,onChange:()=>{},placeholder:"Not supported",required:l,type:"text",value:""});Ae.defaultProps={hint:null,error:void 0,labelAction:void 0,required:!1},Ae.propTypes={error:t().string,hint:t().string,label:t().string.isRequired,labelAction:t().element,name:t().string.isRequired,required:t().bool};var Bn=Ae;const De=({autoComplete:e,customInputs:n,description:r,disabled:o,intlLabel:a,labelAction:l,error:c,name:s,onChange:u,options:m,placeholder:f,required:g,step:h,type:v,value:y,isNullable:T,attribute:b,...R})=>{const{formatMessage:I}=(0,x.useIntl)(),{hint:E}=jn({description:r,fieldSchema:b,type:b?.type||v}),[_,k]=(0,d.useState)(!1),L=n?n[v]:null,C=y??void 0,j=C??"";function Y(S){if(!S)return null;const q={...S.values};return I(typeof S=="string"?{id:S,defaultMessage:S}:{id:S.id,defaultMessage:S?.defaultMessage??S.id},q)}const O=Y(c);if(L)return i().createElement(L,{...R,attribute:b,description:r,hint:E,disabled:o,intlLabel:a,labelAction:l,error:O,name:s,onChange:u,options:m,required:g,placeholder:f,type:v,value:C});const F=a.id?I({id:a.id,defaultMessage:a.defaultMessage},{...a.values}):s,B=f?I({id:f.id,defaultMessage:f.defaultMessage},{...f.values}):"";switch(v){case"json":return i().createElement(p.JSONInput,{label:F,labelAction:l,value:C,error:O,disabled:o,hint:E,required:g,onChange:S=>{const q=!b.required&&!S.length?null:S;u({target:{name:s,value:q}})},minHeight:D(252),maxHeight:D(504)});case"bool":{const S={clearLabel:T&&I({id:"app.components.ToggleCheckbox.clear-label",defaultMessage:"Clear"}),onClear:T&&(()=>{u({target:{name:s,value:null}})})};return i().createElement(p.ToggleInput,{checked:y===null?null:y||!1,disabled:o,hint:E,label:F,error:O,labelAction:l,name:s,offLabel:I({id:"app.components.ToggleCheckbox.off-label",defaultMessage:"False"}),onLabel:I({id:"app.components.ToggleCheckbox.on-label",defaultMessage:"True"}),onChange:q=>{u({target:{name:s,value:q.target.checked}})},required:g,...S})}case"checkbox":return i().createElement(p.Checkbox,{disabled:o,error:O,hint:E,id:s,name:s,onValueChange:S=>{u({target:{name:s,value:S}})},required:g,value:Boolean(C)},F);case"datetime":return i().createElement(p.DateTimePicker,{clearLabel:I({id:"clearLabel",defaultMessage:"Clear"}),disabled:o,error:O,label:F,labelAction:l,id:s,hint:E,name:s,onChange:S=>{const q=S?S.toISOString():null;u({target:{name:s,value:q,type:v}})},onClear:()=>u({target:{name:s,value:null,type:v}}),placeholder:B,required:g,value:C?new Date(C):void 0});case"date":return i().createElement(p.DatePicker,{clearLabel:I({id:"clearLabel",defaultMessage:"Clear"}),disabled:o,error:O,label:F,labelAction:l,id:s,hint:E,name:s,onChange:S=>{u({target:{name:s,value:Rt()(S,{representation:"date"}),type:v}})},onClear:()=>u({target:{name:s,value:null,type:v}}),placeholder:B,required:g,selectedDate:C?new Date(C):void 0,selectedDateLabel:S=>`Date picker, current is ${S}`});case"number":return i().createElement(p.NumberInput,{disabled:o,error:O,label:F,labelAction:l,id:s,hint:E,name:s,onValueChange:S=>u({target:{name:s,value:S,type:v}}),placeholder:B,required:g,step:h,value:C});case"email":return i().createElement(p.TextInput,{autoComplete:e,disabled:o,error:O,label:F,labelAction:l,id:s,hint:E,name:s,onChange:u,placeholder:B,required:g,type:"email",value:j});case"timestamp":case"text":case"string":return i().createElement(p.TextInput,{autoComplete:e,disabled:o,error:O,label:F,labelAction:l,id:s,hint:E,name:s,onChange:u,placeholder:B,required:g,type:"text",value:j});case"password":return i().createElement(p.TextInput,{autoComplete:e,disabled:o,error:O,endAction:i().createElement("button",{"aria-label":I({id:"Auth.form.password.show-password",defaultMessage:"Show password"}),onClick:()=>{k(S=>!S)},style:{border:"none",padding:0,background:"transparent"},type:"button"},_?i().createElement(p.Icon,{as:P.Eye,color:"neutral500"}):i().createElement(p.Icon,{as:P.EyeStriked,color:"neutral500"})),label:F,labelAction:l,id:s,hint:E,name:s,onChange:u,placeholder:B,required:g,type:_?"text":"password",value:j});case"select":return i().createElement(p.Select,{disabled:o,error:O,label:F,labelAction:l,id:s,hint:E,name:s,onChange:S=>u({target:{name:s,value:S,type:"select"}}),placeholder:B,required:g,value:C},m.map(({metadatas:{intlLabel:S,disabled:q,hidden:K},key:rt,value:ot})=>i().createElement(p.Option,{key:rt,value:ot,disabled:q,hidden:K},I(S))));case"textarea":return i().createElement(p.Textarea,{disabled:o,error:O,label:F,labelAction:l,id:s,hint:E,name:s,onChange:S=>u({target:{name:s,value:S.target.value,type:v}}),required:g,placeholder:B,type:v,value:j});case"time":{let S=C;if(C&&C.split(":").length>2){const[q,K]=C.split(":");S=`${q}:${K}`}return i().createElement(p.TimePicker,{clearLabel:I({id:"clearLabel",defaultMessage:"Clear"}),disabled:o,error:O,label:F,labelAction:l,id:s,hint:E,name:s,onChange:q=>{u({target:{name:s,value:`${q}`,type:v}})},onClear:()=>{u({target:{name:s,value:null,type:v}})},placeholder:B,required:g,value:S})}default:return i().createElement(Bn,{name:s,label:F,labelAction:l,hint:E,error:O,required:g})}};De.defaultProps={autoComplete:void 0,customInputs:null,description:null,disabled:!1,error:"",isNullable:void 0,labelAction:void 0,placeholder:null,required:!1,options:[],step:1,value:void 0,attribute:null},De.propTypes={autoComplete:t().string,customInputs:t().object,description:t().shape({id:t().string.isRequired,defaultMessage:t().string.isRequired,values:t().object}),attribute:t().object,disabled:t().bool,error:t().oneOfType([t().string,t().shape({id:t().string.isRequired,defaultMessage:t().string})]),intlLabel:t().shape({id:t().string.isRequired,defaultMessage:t().string.isRequired,values:t().object}).isRequired,isNullable:t().bool,labelAction:t().element,name:t().string.isRequired,onChange:t().func.isRequired,options:t().arrayOf(t().shape({metadatas:t().shape({intlLabel:t().shape({id:t().string.isRequired,defaultMessage:t().string.isRequired}).isRequired,disabled:t().bool,hidden:t().bool}).isRequired,key:t().oneOfType([t().string,t().number]).isRequired,value:t().oneOfType([t().string,t().number]).isRequired}).isRequired),placeholder:t().shape({id:t().string.isRequired,defaultMessage:t().string.isRequired,values:t().object}),required:t().bool,step:t().number,type:t().string.isRequired,value:t().any};var Nn=De;/**
 * @preserve
